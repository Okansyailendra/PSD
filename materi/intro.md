...
.hero-header {
  text-align: center;
  padding: 4rem 2rem;
  background: linear-gradient(135deg, var(--nature-light), var(--nature-dark));
  color: white;
  border-radius: 16px;
  margin-bottom: 3rem;
...
.nature-card {
  ...
  padding: 2rem;
  border-radius: 16px;
  box-shadow: 0 8px 25px rgba(44, 95, 45, 0.06);
...
<div class="intro-container">
  ...
  <div class="nature-section">
    ...
    <p>Buku ini dibuat menggunakan <a href="https://jupyterbook.org" style="color: var(--nature-dark); font-weight: bold; text-decoration: none;">Jupyter Book</a>. Beberapa hal yang dapat Anda lakukan:</p>
    <ul class="nature-list">
